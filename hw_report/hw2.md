## hw2
### Итоги
1. Обратный индекс дает наибольшую производительность, поскольку оптимизирован под поиск по префиксу
2. Btree индекс, дает увеличение производительности только в 2 раза
### Как повторить
```shell
